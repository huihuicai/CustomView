...
public class SpringNestedScroll extends NestedScrollView {
    ...
    public SpringNestedScroll(Context context) {
        this(context, null);
    }

    public SpringNestedScroll(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpringNestedScroll(Context context, AttributeSet attrs, int defStyleAttr) {
